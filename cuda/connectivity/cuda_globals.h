...
__device__ double dev_K_over_Na[n_pop] ; 
...
__device__ double prefactor[N_NEURONS], dev_theta[N_NEURONS] ; 
...
__host__ void copyHostGlobalsToDev() {
  ...
  cudaCheck(cudaMemcpyToSymbol( dev_K_over_Na, &K_over_Na, n_pop * sizeof(double) ) ) ; 
