...
drift_off_avg = stat.circmean(drift_off[..., 12:16], high=90, low=-90, axis=-1, nan_policy='omit') 
...
path = path.replace('christos_off', 'on_3') # change dirname 
...
drift_on_avg = stat.circmean(drift_on[..., 12:16], high=90, low=-90, axis=-1, nan_policy='omit') 
