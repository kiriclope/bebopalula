...
#define TIME_REC (double) 10.00E3 // 1.00E3 // 10.E3 // 
#define TIME_REC_SPIKES (double) 2.00E3 // 1.00E3 // 10.E3 // 
...
double *ext_inputs, *ff_inputs, *J, *tau_syn , *J_scaled, *ext_inputs_scaled ; 
...
#define KAPPA_EXT (double) 0.5 
#define PHI_EXT (double) 3*M_PI/2.0 
...
const double TAU_MEM[2] = {10.0, 10.0} ; 
...
#define TAU_FAC (double) 750 
#define TAU_REC (double) 250 
#define USE (double) 0.05 
