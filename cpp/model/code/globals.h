...
poisson_distribution<int> poisson(5.0) ;
...
#define TIME_STEADY (double) 2.000E3 //  2.0E3 // 10.E3 // 
...
#define KAPPA (double) 15.0 // 12.0 14 
...
#define KAPPA_1 (double) .2 // 8.0 12 
...
#define COVAR_KSI (double) 10.0/sqrt(2000.0) 

#define ANGLE_KSI (double) M_PI/4.0 

double *ksi, *ksi_1, *ksi_init, *ksi_scaled, *ksi_1_scaled, *gauss ; 
string con_path ; 
string ksi_path ; 
...
#define KAPPA_EXT (double) 0.15  
#define PHI_EXT (double) M_PI/2.0 

#define KAPPA_DIST (double) 0.2 
...
#define T_ERASE_ON (double) 6000
#define T_ERASE_OFF (double) 7000

const double A_CUE[2] = {.24, .10} ; 
const double EPS_CUE[2] = {0.17, 0.0} ; 
